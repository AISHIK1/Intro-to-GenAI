...
class review(TypedDict):
    key_themes:Annotated[list[str],"Mention all the key themes that are discussed in the review"]
    summary:Annotated[str,'Provide a concise summary of the review in 2-3 sentences']
    sentiment: Annotated[Literal['Pos','Neg'],'Classify the overall sentiment of the review as Positive, Negative, or Neutral']
    pros:Optional[Annotated[list[str],'Write down the pros in points, if you cant find any pros write None']]
    cons:Optional[Annotated[list[str],'Write down the cons in points, if you cant find any cons write None']]
    reviewer:Annotated[str,'Mention the name of the reviewer if there is not write its annonymous']
